...
const units = [
...

  {
    ...
    items: [
      { name: "2.1–2.2 Position, Distance, Displacement & Avg Velocity", href: "./unitLessons/index.html#/P2_1_2positionVelocity?view=overview", notes: { name: "2.1 & 2.2 Guided Notes",  href:"./documents/GuidedNotes/2.1GuidedNotes.pdf", password: "notes2122" } },
      { name: "2.3 Instantaneous Velocity", href: "./unitLessons/index.html#/P2_3instantaneousVelocity?view=overview", notes: {name: "2.3  Guided Notes", href: "./documents/GuidedNotes/2.3GuidedNotes.pdf", password: "notes23" } },
      { name: "2.4 Average Acceleration", href: "./unitLessons/index.html#/P2_4averageAcceleration?view=overview", notes: {name: "2.4 Guided Notes", href: "./documents/GuidedNotes/2.4GuidedNotes.pdf", password: "notes24"} }
    ]
  },
        ...
        <section className="grid md:grid-cols-5 gap-4 items-center">
          ...
          <div className="md:col-span-2 p-6 rounded-2xl border border-zinc-800 bg-zinc-900/60">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="./toolviewer/" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:no-underline">Physics Toolkit ↗</a></li>
            </ul>
          </div>
        </section>
