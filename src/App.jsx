...
const units = [
  { id: 1, title: "Unit 1 — The Science of Physics", items: [
    ...
    {name: "1.3 Measurement", href: "./units/1_3measurement/index.html", password: "", notes: { name: "1.3 Guided Notes", href: "./documents/GuidedNotes/1_3GuidedNotes.pdf", password: "" }},
    { name: "1.4 Math Tools", href: "./units/1_4mathTools/index.html", password: "", notes: { name: "1.4 Guided Notes", href: "./documents/GuidedNotes/1_4GuidedNotes.pdf", password: "" }},
    { name: "1.5 Vectors", href: "./units/1_5vectors/index.html", password: "", notes: { name: "1.5 Guided Notes", href: "./documents/GuidedNotes/1_5GuidedNotes.pdf", password: "" }},
